#!/usr/bin/env bash
# Run inference with Qwen/Qwen3-VL-2B-Instruct (GGUF via llama.cpp).
#
...
#     export MODEL_URL_GGUF_QWEN3_VL_2B_INSTRUCT='https://...'
#     bash models/Qwen3-VL-2B-Instruct/run.sh
#
...
MODEL_URL_ENV="MODEL_URL_GGUF_QWEN3_VL_2B_INSTRUCT"
