#!/usr/bin/env bash
# Run agentic inference with LiquidAI/LFM2.5-VL-1.6B (GGUF via llama.cpp): thinking + tool calls.
#
...
#     bash models/LFM2.5-VL-1.6B/run_agentic.sh
#
...
MODEL_URL_ENV="MODEL_URL_GGUF_LFM2_5_1_6B"
