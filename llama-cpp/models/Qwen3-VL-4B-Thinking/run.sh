#!/usr/bin/env bash
# Run agentic inference with Qwen/Qwen3-VL-4B-Thinking (GGUF via llama.cpp): thinking + tool calls.
#
...
#     export MODEL_URL_GGUF_QWEN3_VL_4B_THINKING='https://...'
#     bash models/Qwen3-VL-4B-Thinking/run.sh
#
...
MODEL_URL_ENV="MODEL_URL_GGUF_QWEN3_VL_4B_THINKING"
