#!/usr/bin/env bash
# Run inference with google/gemma-3-4b-pt (GGUF via llama.cpp).
#
...
#     export MODEL_URL_GGUF_GEMMA_3_4B_PT='https://...'
#     bash models/gemma-3-4b-pt/run.sh
#
...
MODEL_URL_ENV="MODEL_URL_GGUF_GEMMA_3_4B_PT"
