#!/usr/bin/env bash
# Run inference with google/gemma-3-4b-it (GGUF via llama.cpp).
#
...
#     export MODEL_URL_GGUF_GEMMA_3_4B_IT='https://...'
#     bash models/gemma-3-4b-it/run.sh
#
...
MODEL_URL_ENV="MODEL_URL_GGUF_GEMMA_3_4B_IT"
