#!/usr/bin/env bash
# Run inference with LiquidAI/LFM2-VL-1.6B (GGUF via llama.cpp).
#
...
#     export MODEL_URL_GGUF_LFM2_VL_1_6B='https://...'
#     bash models/LFM2-VL-1.6B/run.sh
#
...
MODEL_URL_ENV="MODEL_URL_GGUF_LFM2_VL_1_6B"
