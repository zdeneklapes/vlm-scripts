#!/usr/bin/env bash
# Run agentic inference with google/gemma-4-E2B-it (GGUF via llama.cpp): thinking + tool calls.
#
...
#     export MODEL_URL_GGUF_GEMMA_4_E2B_IT='https://...'
#     bash models/gemma-4-E2B-it/run_agentic.sh
#
...
MODEL_URL_ENV="MODEL_URL_GGUF_GEMMA_4_E2B_IT"
