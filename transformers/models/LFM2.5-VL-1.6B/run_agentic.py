#!/usr/bin/env python3
"""Run agentic inference with LiquidAI/LFM2.5-VL-1.6B.

This model emits thinking and tool calls alongside its answer
(<think>...</think> + <|tool_call_start|>[name(arg=val)]<|tool_call_end|>). Output is parsed into separate
...
generation settings. The model is downloaded automatically on first run:
    ...
    uv run models/LFM2.5-VL-1.6B/run_agentic.py
