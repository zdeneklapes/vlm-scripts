...
MODEL_URL_HF_LFM2_VL_1_6B to the download URL from your model's details
page at https://app.ximilar.com/platform/vlm/tasks/ and run:

    export MODEL_DOWNLOAD_DIRECTORY=./stored
    export MODEL_URL_HF_LFM2_VL_1_6B='https://...'
    uv run models/LFM2-VL-1.6B/run.py
"""
...
# --- Model -------------------------------------------------------------------
MODEL_ID = "LiquidAI/LFM2-VL-1.6B"  # HuggingFace ID -- used as base model for LoRA adapters
MODEL_URL_ENV = "MODEL_URL_HF_LFM2_VL_1_6B"  # env var holding the model download URL
